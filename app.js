...
(function() {
  var MeCab, app, auth, cheerio, dict, express, getListByYahoo, http, io, mecab, path, routes, server, user, _;
  ...
  getListByYahoo = function(socket, word, hop, next) {
    var options, origin;
        ...
        try {
          ...
          return mecab.parse(src, function(err, result) {
            ...
            for (_j = 0, _len1 = dict.length; _j < _len1; _j++) {
              ...
              if (hop < 3) {
                _results.push(getListByYahoo(socket, word.text, hop, word.text + " " + origin.text));
              } else {
  ...
  io.sockets.on('connection', function(socket) {
    ...
    socket.on('word', function(word) {
      return getListByYahoo(socket, word, 1, word);
    });
